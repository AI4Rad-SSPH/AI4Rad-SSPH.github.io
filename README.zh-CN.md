...
| 项目 | 期刊 | 链接 |
|---|---|---|
| **影像驱动卒中 MLLM** — 面向急性缺血性卒中影像驱动治疗推荐的多智能体多模态大语言模型框架 | 《npj 数字医学》, 2026 | [论文](https://www.nature.com/articles/s41746-026-03066-7) |
| **HR-LLM-Stroke** — 面向急诊卒中治疗推荐的多智能体大语言模型框架 | 《医学互联网研究杂志》, 2026 | [论文](https://www.jmir.org/2026/1/e96304) · [代码](https://github.com/FrankZhangRp/HR-LLM-Stroke) · [演示](https://frankzhangrp.github.io/HR-LLM-Stroke/) |
